      ...
      <div className="bg-gray-100 p-4">
        ...
        <div className='flex gap-4'>
          ...
          <div className='ml-auto'>
            <Dropdown isOwner={username === currentUser}/>
          </div>
      ...
      <div className="p-4 bg-gray-100">
        ...
        <ul className="space-y-1">
          {profileData.history.map((game, index) => (
            <li
              key={index}
              className={`text-sm text-gray-600 flex justify-between p-2 hover:bg-blue-200 rounded-md ${index % 2 === 0 ? 'bg-gray-200' : 'bg-gray-100'}`}
            >
